...
namespace {
struct qt_meta_tag_ZN11SimpleGraphE_t {};
} // unnamed namespace

template <> constexpr inline auto SimpleGraph::qt_create_metaobjectdata<qt_meta_tag_ZN11SimpleGraphE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'graphUpdated'
        QtMocHelpers::SignalData<void(SimpleGraph)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 0, 3 },
        }}),
    };
    ...
    return QtMocHelpers::metaObjectData<SimpleGraph, qt_meta_tag_ZN11SimpleGraphE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject SimpleGraph::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11SimpleGraphE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11SimpleGraphE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11SimpleGraphE_t>.metaTypes,
    nullptr
} };

void SimpleGraph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<SimpleGraph *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->graphUpdated((*reinterpret_cast< std::add_pointer_t<SimpleGraph>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::RegisterMethodArgumentMetaType) {
        ...
        case 0:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< SimpleGraph >(); break;
            }
            break;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SimpleGraph::*)(SimpleGraph )>(_a, &SimpleGraph::graphUpdated, 0))
            return;
    }
}
...
void *SimpleGraph::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11SimpleGraphE_t>.strings))
